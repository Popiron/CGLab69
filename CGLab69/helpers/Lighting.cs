...
namespace CGLab69.helpers
{
    class Lighting
    {
        ...
        public static Bitmap lighting(int width, int height, Polyhedron figure, Point3D lightPoint, Color polyhedronColor)
        {
